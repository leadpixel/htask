...
impl Ord for Task {
    fn cmp(&self, other: &Self) -> std::cmp::Ordering {
        self.status
            ...
            .then(self.task_uuid.0.cmp(&other.task_uuid.0))
    }
}
...
impl Task {
    pub fn priority_order(&self, other: &Self) -> std::cmp::Ordering {
        self.created_at
            .cmp(&other.created_at)
            .then(self.task_uuid.0.cmp(&other.task_uuid.0))
    }

    pub fn display_order(&self, other: &Self) -> std::cmp::Ordering {
        self.status
            .cmp(&other.status)
            .then(self.priority_order(other))
    }
}
